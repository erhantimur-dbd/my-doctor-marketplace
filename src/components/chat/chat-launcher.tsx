...
/**
 * Closed-state floating card shown in the bottom-right corner of every
 * public page. Inspired by the TopDoctors chat launcher: a rounded card
 * with the AI tagline, a cute mascot with two eyes, and a prominent white
 * "Find specialist" CTA button. On mobile we collapse to a compact round
 * icon button to preserve tap area without blocking scroll content.
 */
