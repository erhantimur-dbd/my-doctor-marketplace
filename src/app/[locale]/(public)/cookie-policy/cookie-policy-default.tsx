...
/**
 * Default (cross-region) Cookie Policy.
 *
 * Served on .com, .eu, and any non-UK host. The UK variant
 * (`cookie-policy-uk.tsx`) is served on .co.uk and adds ICO / PECR-specific
 * language, the UK legal entity, and the ICO complaint pathway. Do not edit
 * this file to make UK-specific changes — those belong in
 * `cookie-policy-uk.tsx`. This content should stay byte-for-byte equivalent
 * to what we&rsquo;ve always served on .com/.eu unless a global update is needed.
 */

const EFFECTIVE_DATE = "17 March 2026";
const COMPANY = "MyDoctors360";

export function CookiePolicyDefault() {
  return (
