-- ============================================================================
-- Demo persona seed — fictional doctors, patients, bookings.
-- Run AFTER seed-catalog.sql on the DEMO database only.
-- Never run on live. All users have password: Password123!
-- Safe to re-run: cleans up existing seed personas first.
-- ============================================================================
