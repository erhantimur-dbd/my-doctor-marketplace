...
| # | URL | Expected | Result |
|---|-----|----------|--------|
| S1 | `{BASE}/en/register-doctor?tier=free&founding=1` | App wizard (not coming-soon). H1: Join the Founding Doctor Programme. Perk line under H1: lifetime Founding Free · Solo Professional features · value £299/mo · Founding Free £0, no card. Founding Free pre-selected. | **PASS** Preview H1 + perk line (this follow-up) |
| S2 | `{BASE}/en/register-doctor` | Same wizard H1 + perk line; plan step includes Founding Free £0. | **PASS** Preview H1 + perk line (this follow-up) |
